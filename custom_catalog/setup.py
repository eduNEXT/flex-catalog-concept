#!/usr/bin/env python
"""
Package metadata for custom_catalog.
"""
import os
import re
import sys
...
VERSION = get_version('custom_catalog', '__init__.py')
...
setup(
    name='custom_catalog',
    version=VERSION,
    description="""Testing how a custom implementation of a catalog would work""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Felipe Montoya',
    author_email='felipe.montoya@edunext.co',
    url='https://github.com/edunext/custom_catalog',
