...
"""
flex_catalog documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'flex_catalog',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edunext/flex_catalog",
...
#
# html_title = 'flex_catalog v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Testing the ergonomics of a flexible catalog',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'flex_catalog'),
                os.path.join(root_path, 'flex_catalog/migrations')])
