#!/usr/bin/env python
"""
Package metadata for flex_catalog.
"""
import os
import re
import sys
...
VERSION = get_version('flex_catalog', '__init__.py')
...
setup(
    name='flex_catalog',
    version=VERSION,
    description="""Testing the ergonomics of a flexible catalog""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Felipe Montoya',
    author_email='felipe.montoya@edunext.co',
    url='https://github.com/edunext/flex_catalog',
